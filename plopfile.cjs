...
module.exports = function (plop) {
    ...
    //npm run plop-controller  -- --name=Categories   --path=GuidePlatform.API\Controllers
    //npm run plop-getall -- --name=GetAllCategories  --path=GuidePlatform.Application/Features/Queries
    //npm run plop-getalldropboxes -- --name=GetAllDropboxesCategories  --path=GuidePlatform.Application/Features/Queries
    //npm run plop-getbyid -- --name=GetCategoriesById  --path=GuidePlatform.Application/Features/Queries
    //npm run plop-update -- --name=UpdateCategories  --path=GuidePlatform.Application/Features/Commands
    //npm run plop-delete -- --name=DeleteCategories  --path=GuidePlatform.Application/Features/Commands
    //npm run plop-create -- --name=CreateCategories  --path=GuidePlatform.Application/Features/Commands
    //npm run plop-viewModel -- --name=Categories  --path=GuidePlatform.Domain/Entities
    //npm run plop-map -- --name=Categories  --path=GuidePlatform.Domain/Maps
    //npm run plop-dto -- --name=Categories  --path=GuidePlatform.Application/Dtos/ResponseDtos
    ...
    let tableDb = 'categories';
    let table = 'categories';

    //Asp Controller
    let nameController = 'categories'; //{{nameController}}Controller
    let nameCon = 'Kategoriler tablosu';
    ...
    args.forEach(arg => {
     ...
     plop.setGenerator('list', {
      ...
      actions: [
          {
              type: 'add',
              path: path.resolve(__dirname,destPath, `${nameController}Controller.cs`),
        ...
        actions: [
            {
                type: 'add',
                path: path.resolve(__dirname, destPath, `${folder}/${name}/${name}QueryHandler.cs`),
                templateFile: path.resolve(__dirname, 'plop-templates/Asp/Features/Queries/GetAllDropboxes/queryHandler.hbs'),
                data: { name,folder,application,tableDb,table }
            },
            {
                type: 'add',
                path: path.resolve(__dirname, destPath, `${folder}/${name}/${name}QueryRequest.cs`),
                templateFile: path.resolve(__dirname, 'plop-templates/Asp/Features/Queries/GetAllDropboxes/queryRequest.hbs'),
                data: { name,folder,application,tableDb,table }
            },
            {
                type: 'add',
                path: path.resolve(__dirname, destPath, `${folder}/${name}/${name}QueryResponse.cs`),
                templateFile: path.resolve(__dirname, 'plop-templates/Asp/Features/Queries/GetAllDropboxes/queryResponse.hbs'),
                data: { name,folder,application,tableDb,table }
            },
        ]
      });
        ...
        actions: [
            {
                type: 'add',
                path: path.resolve(__dirname, destPath, `${folder}/${name}/${name}QueryHandler.cs`),
                templateFile: path.resolve(__dirname, 'plop-templates/Asp/Features/Queries/GetByUserId/queryHandler.hbs'),
                data: { name,folder,application,tableDb,table }
            },
            {
                type: 'add',
                path: path.resolve(__dirname, destPath, `${folder}/${name}/${name}QueryRequest.cs`),
                templateFile: path.resolve(__dirname, 'plop-templates/Asp/Features/Queries/GetByUserId/queryRequest.hbs'),
                data: { name,folder,application,tableDb,table }
            },
            {
                type: 'add',
                path: path.resolve(__dirname, destPath, `${folder}/${name}/${name}QueryResponse.cs`),
                templateFile: path.resolve(__dirname, 'plop-templates/Asp/Features/Queries/GetByUserId/queryResponse.hbs'),
                data: { name,folder,application,tableDb,table }
            },
        ]
      });
        ...
        actions: [
            {
                ...
                templateFile: path.resolve(__dirname, 'plop-templates/Asp/Entities/viewModel.hbs'),
                data: { name,folder,application,tableDb,table }
            }
        ]
      });
        ...
        actions: [
            {
              ...
              templateFile: path.resolve(__dirname, 'plop-templates/Asp/Maps/map.hbs'),
              data: { name,folder,application,tableDb,table }
            }
        ]
      });
        ...
        actions: [
            {
              ...
              templateFile: path.resolve(__dirname, 'plop-templates/Asp/DTOS/dto.hbs'),
              data: { name,folder,application,tableDb,table }
            }
        ]
      });
